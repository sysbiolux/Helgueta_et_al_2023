---
title: "RNA-seq analysis of Park7 KO Males 8 months of age"
...
Analysis of RNA-seq midbrain data from 4 Park7 KnockOut and 4 Wildtype male mice at 8 months of age
...
colnames(rawcounts) <- c("D007_KO", "D0021_KO", "D0023_WT", "D0036_WT", "D0037_KO", "D0026_KO", "D0022_WT", "D0020_WT")
```
...
```{r}
genotype <- c("KnockOut", "KnockOut", "WildType", "WildType", "KnockOut", "KnockOut", "WildType", "WildType")
```
...
rownames(info.data) <- c("D007_KO", "D0021_KO", "D0023_WT", "D0036_WT", "D0037_KO", "D0026_KO", "D0022_WT", "D0020_WT") 
```
