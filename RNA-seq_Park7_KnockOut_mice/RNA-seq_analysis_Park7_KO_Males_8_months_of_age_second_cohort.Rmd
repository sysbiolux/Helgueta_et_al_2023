---
title: "RNA-seq analysis of Park7 KO Males 8 months of age second cohort"
...
Analysis of RNA-seq midbrain data from 4 Park7 KnockOut and 4 Wildtype female mice at 8 months of age
...
```{r}
ls fastq/*z | paste - - | awk 'BEGIN{OFS="\t";print "sample\tunit\tfq1\tfq2\tstrandedness"}{id=substr($1,index($1,"/")+1,index($1,"_EFPFU")-7);print id,"1",$1,$2, "reverse"}' | sed 's/\-/_/' > config/units.tsv
```

Regarding **samples.tsv**:

```{r}
ls fastq/*z | paste - - | awk 'BEGIN{OFS="\t";print "sample\tcondition"}{id=substr($1,index($1,"/")+1,index($1,"_EFPFU")-7);print id,id}' | sed 's/[0-9]$//; s/\-/_/g' > config/samples.tsv
```
...
colnames(rawcounts) <- c("D0546_KO", "D0548_KO", "D0549_WT", "D0561_KO", "D0564_WT", "D0570_KO", "D0585_WT", "D0612_WT")
```
...
```{r}
genotype <- c("KnockOut", "KnockOut", "WildType", "KnockOut", "WildType", "KnockOut", "WildType", "WildType")
```
...
rownames(info.data) <- c("D0546_KO", "D0548_KO", "D0549_WT", "D0561_KO", "D0564_WT", "D0570_KO", "D0585_WT", "D0612_WT") 
```
