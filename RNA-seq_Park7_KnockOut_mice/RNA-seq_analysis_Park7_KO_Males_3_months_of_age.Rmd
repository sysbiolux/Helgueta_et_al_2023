---
title: "RNA-seq analysis of Park7 KO Males 3 months of age"
...
Analysis of RNA-seq midbrain data from 4 Park7 KnockOut and 4 Wildtype male mice at 3 months of age
...
colnames(rawcounts) <- c("D0019_KO", "D0024_KO", "D0039_KO", "D0041_WT", "D0046_WT", "D0040_WT", "D0032_WT", "D0023_KO")
```
...
```{r}
genotype <- c("KnockOut", "KnockOut", "KnockOut", "WildType", "WildType", "WildType", "WildType", "KnockOut")
```
...
rownames(info.data) <- c("D0019_KO", "D0024_KO", "D0039_KO", "D0041_WT", "D0046_WT", "D0040_WT", "D0032_WT", "D0023_KO") 
```
